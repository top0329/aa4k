...
import { Aa4kApiOpeAiProxyStack } from '../lib/api-openai-proxy-stack';
...
new Aa4kApiOpeAiProxyStack(app, `Aa4k-ApiOpeAiProxyStack-${stageName}`, contextProps, secretsStack, stackProps);
