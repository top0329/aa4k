...
export const insertHandler = async (req: Request, res: Response) => {
  ...
  let retErrorCode: ErrorCode = ErrorCode.A10199;
  ...
  try {
    ...
    switch (body.messageType) {
      case MessageType.human:
        // 会話履歴TBLへのユーザー発言の登録
        const queryResult = await insertConversationHistory(dbClient, subscriptionId, body);
