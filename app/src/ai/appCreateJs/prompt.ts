...
# 変更例の例:
\`\`\`
・変換のタイミングを変更したいときは、「変換のタイミングを値を変更した時に変換するようにしてください」と指示してください。
・背景色を変更したいときは、「背景色を青色に変更してください」と指示してください。
・対象のフィールドを変更したいときは、「クリアする条件を社員番号ではなく、○○に変更してください」と指示してください。
\`\`\`
