 ...
 * @returns AiResponse
 */
export const dataGenerationExecute = async (conversation: Conversation): Promise<AiResponse> => {
...
// - 「create」の場合は、作成するダミーデータの件数を number として出力し、作成するダミーデータの条件を condition として出力してください。
...
//     ]
    ...
    if (isAddRecords) {
      ...
      responseMessage = resultAddRecord.responseMessage;
