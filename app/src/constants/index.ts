...
export const InfoMessage = {
  ...
  I_MSG005: "ダミーデータの生成に成功しました。",
  I_MSG006: "別の機能がAI処理を実行中です。完了するまでお待ちください。",
} as const;
...
export const ErrorMessage = {
  ...
  E_MSG010: "ダミーデータの生成に失敗しました。",
  E_MSG011: "予期せぬ問題が発生したため生成に失敗しました。再度実行しても事象が改善されない場合は管理者にお問い合わせください。",
  E_MSG012: "AIによる生成に失敗しました。再実行するか、より詳しい表現に変えてお試しください。",
} as const;
